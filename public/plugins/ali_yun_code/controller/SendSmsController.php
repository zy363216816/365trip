 ...
 * Time: 14:02
 */
namespace plugins\ali_yun_code\controller;
ini_set("display_errors", "on");

require_once dirname(__DIR__) . '/sdk/api_sdk/vendor/autoload.php';
...
class SendSmsController
{
     ...
     * @return stdClass
     */
    public static function sendSms($mobile, $signName, $templateCode, $keyId, $keySecret, $code,$expireTime)
    {
